...
Data sets for the AIDA cloud chamber experiment are described in Lamb et al. 2017, Clouser et al. 2020, and Lamb et al. 2023. Pre-processing scripts for the AIDA data sets can be found [here](https://github.com/kdlamb/icedeposition).
...
used in the NODE model. The [PySR library](https://github.com/MilesCranmer/PySR) is used for symbolic regression. 
